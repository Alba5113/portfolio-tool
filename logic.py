...
class DB_Manager:
    ...
    def get_statuses(self):
        # sql = "SELECT status_id FROM status WHERE status_name = ?" # Doğru SQL sorgusunu buraya girin
        # return self.__select_data(sql, (statuses))
        return statuses
...
"""
    ...
    def update_projects(self, param, data):
        sql = f"UPDATE projects SET project = ?" # Doğru SQL sorgusunu buraya girin
        self.__executemany(sql, [data]) 
